...
export interface GlobalSession extends ClassHandle {
  getBuiltinModuleSource(_0: EmbindString): string;
...
export interface ProgramLayout extends ClassHandle {
  ...
  findTypeByName(_0: EmbindString): TypeReflection | null;
  findVarByNameInType(_0: TypeReflection | null, _1: EmbindString): VariableReflection | null;
}
