...
import slangModule from './slang-2026.17-wasm/slang-wasm.js'
...
/** @type {Promise<import('./slang-2026.17-wasm/slang-wasm.js').MainModule> | null} */
let slangPromise = null

/** @type {import('./slang-2026.17-wasm/slang-wasm.js').GlobalSession | null} */
  ...
  return {
    ...
    transform: {
      ...
      async handler(code, id) {
        ...
        /** @type {import('./slang-2026.17-wasm/slang-wasm.js').Session | null} */
        let session = null
        ...
        try {
          ...
          /** @type {import('./slang-2026.17-wasm/slang-wasm.js').Module | null} */
          ...
          /** @type {import('./slang-2026.17-wasm/slang-wasm.js').Module[]} */
          const components = [module]
          for (let i = 0; i < count; i++) {
            /** @type {import('./slang-2026.17-wasm/slang-wasm.js').EntryPoint} */
            const entryPoint = module.getDefinedEntryPoint(i)
            /** @type {import('./slang-2026.17-wasm/slang-wasm.js').ComponentType} */
