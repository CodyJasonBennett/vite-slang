...
export type SlangDeclKind =
  | SlangDeclKindValue<0>
  | SlangDeclKindValue<1>
  | SlangDeclKindValue<2>
  | SlangDeclKindValue<3>
  | SlangDeclKindValue<4>
  | SlangDeclKindValue<5>
  | SlangDeclKindValue<6>
...
export type DeclReflectionKind =
  | DeclReflectionKindValue<0>
  | DeclReflectionKindValue<1>
  | DeclReflectionKindValue<2>
  | DeclReflectionKindValue<3>
  | DeclReflectionKindValue<4>
  | DeclReflectionKindValue<5>
  | DeclReflectionKindValue<6>
...
export type TypeReflectionKind =
  | TypeReflectionKindValue<0>
  | TypeReflectionKindValue<1>
  | TypeReflectionKindValue<2>
  | TypeReflectionKindValue<3>
  | TypeReflectionKindValue<4>
  | TypeReflectionKindValue<5>
  | TypeReflectionKindValue<6>
  | TypeReflectionKindValue<7>
  | TypeReflectionKindValue<8>
  | TypeReflectionKindValue<9>
  | TypeReflectionKindValue<10>
  | TypeReflectionKindValue<11>
  | TypeReflectionKindValue<12>
  | TypeReflectionKindValue<13>
  | TypeReflectionKindValue<14>
  | TypeReflectionKindValue<16>
  | TypeReflectionKindValue<17>
  | TypeReflectionKindValue<18>
  | TypeReflectionKindValue<19>
...
export type BindingType =
  ...
  | BindingTypeValue<2>
  | BindingTypeValue<3>
  | BindingTypeValue<262>
  | BindingTypeValue<261>
  | BindingTypeValue<258>
...
interface EmbindModule {
  ...
  ModifierID: {
    Shared: ModifierIDValue<0>
    NoDiff: ModifierIDValue<1>
    Static: ModifierIDValue<2>
    Const: ModifierIDValue<3>
    Export: ModifierIDValue<4>
    Extern: ModifierIDValue<5>
    Differentiable: ModifierIDValue<6>
    Mutating: ModifierIDValue<7>
    In: ModifierIDValue<8>
    Out: ModifierIDValue<9>
    InOut: ModifierIDValue<10>
  }
  Modifier: {}
  VariableReflection: {}
  ...
  GenericReflection: {}
  SlangDeclKind: {
    SLANG_DECL_KIND_UNSUPPORTED_FOR_REFLECTION: SlangDeclKindValue<0>
    SLANG_DECL_KIND_STRUCT: SlangDeclKindValue<1>
    SLANG_DECL_KIND_FUNC: SlangDeclKindValue<2>
    SLANG_DECL_KIND_MODULE: SlangDeclKindValue<3>
    SLANG_DECL_KIND_GENERIC: SlangDeclKindValue<4>
    SLANG_DECL_KIND_VARIABLE: SlangDeclKindValue<5>
    SLANG_DECL_KIND_NAMESPACE: SlangDeclKindValue<6>
  }
  DeclReflection: {}
  DeclReflectionKind: {
    Unsupported: DeclReflectionKindValue<0>
    Struct: DeclReflectionKindValue<1>
    Func: DeclReflectionKindValue<2>
    Module: DeclReflectionKindValue<3>
    Generic: DeclReflectionKindValue<4>
    Variable: DeclReflectionKindValue<5>
    Namespace: DeclReflectionKindValue<6>
  }
  ScalarType: {
    None: ScalarTypeValue<0>
    Void: ScalarTypeValue<1>
    Bool: ScalarTypeValue<2>
    Int32: ScalarTypeValue<3>
    UInt32: ScalarTypeValue<4>
    Int64: ScalarTypeValue<5>
    UInt64: ScalarTypeValue<6>
    Float16: ScalarTypeValue<7>
    Float32: ScalarTypeValue<8>
    Float64: ScalarTypeValue<9>
    Int8: ScalarTypeValue<10>
    UInt8: ScalarTypeValue<11>
    Int16: ScalarTypeValue<12>
    UInt16: ScalarTypeValue<13>
    IntPtr: ScalarTypeValue<14>
    UIntPtr: ScalarTypeValue<15>
    BFloat16: ScalarTypeValue<16>
    FloatE4M3: ScalarTypeValue<17>
    FloatE5M2: ScalarTypeValue<18>
  }
  TypeReflection: {}
  TypeReflectionKind: {
    None: TypeReflectionKindValue<0>
    Struct: TypeReflectionKindValue<1>
    Array: TypeReflectionKindValue<2>
    Matrix: TypeReflectionKindValue<3>
    Vector: TypeReflectionKindValue<4>
    Scalar: TypeReflectionKindValue<5>
    ConstantBuffer: TypeReflectionKindValue<6>
    Resource: TypeReflectionKindValue<7>
    SamplerState: TypeReflectionKindValue<8>
    TextureBuffer: TypeReflectionKindValue<9>
    ShaderStorageBuffer: TypeReflectionKindValue<10>
    ParameterBlock: TypeReflectionKindValue<11>
    GenericTypeParameter: TypeReflectionKindValue<12>
    Interface: TypeReflectionKindValue<13>
    OutputStream: TypeReflectionKindValue<14>
    Specialized: TypeReflectionKindValue<16>
    Feedback: TypeReflectionKindValue<17>
    Pointer: TypeReflectionKindValue<18>
    DynamicResource: TypeReflectionKindValue<19>
  }
  UserAttribute: {}
  FunctionReflection: {}
  ...
  ProgramLayout: {}
  BindingType: {
    Unknown: BindingTypeValue<0>
    Texture: BindingTypeValue<2>
    ConstantBuffer: BindingTypeValue<3>
    MutableRawBuffer: BindingTypeValue<262>
    MutableTypedBuffer: BindingTypeValue<261>
    MutableTexture: BindingTypeValue<258>
  }
  Module: {}
  getLastError(): Error
  EntryPoint: {}
